...
class TestTopicAnalysis:
    ...
    def test_find_topic_relationships(self, mock_analyzer, mock_chat_data, mock_embeddings):
        ...
        mock_topics = {
            ...
            "Topic 1": {
                "count": 1,
                "keywords": ["topic", "B"],
                "messages": [{"message_id": 3, "text": "Let's discuss topic B also", "from_id": 111}],
            },
            "Topic 2": {
                "count": 1,
                "keywords": ["topic", "C"],
                "messages": [{"message_id": 4, "text": "I prefer topic C", "from_id": 333}],
            },
        }
    ...
    def test_analyze_topic_sentiment(self, mock_analyzer, mock_chat_data):
        ...
        mock_topics = {
            ...
            "Topic 1": {
                "count": 1,
                "keywords": ["topic", "B"],
                "messages": [{"message_id": 3, "text": "I dislike topic B", "from_id": 111}],
            },
        }
    ...
    def test_analyze_cross_chat_topics(self, mock_analyzer, mock_chat_data, mock_embeddings):
        ...
        mock_analyzer.qdrant.scroll.return_value = (
            [
                MagicMock(payload={"message_id": m, "chat_id": c, "text": t, "from_id": f})
                for m, c, t, f in zip(
                    mock_chat_data["message_id"],
                    mock_chat_data["chat_id"],
                    mock_chat_data["text"],
