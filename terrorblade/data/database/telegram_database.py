...
class UserStats:
    ...
    total_messages: int
    total_chats: int
    largest_chat: Tuple[int, str, int]  # (chat_id, chat_name, message_count)
    largest_cluster: Tuple[int, str, int]  # (chat_id, chat_name, cluster_size)
...
class TelegramDatabase:
    ...
    def get_user_stats(self, phone: str) -> Optional[UserStats]:
        ...
        try:
            ...
            # Get largest chat
            largest_chat = chat_stats[0] if chat_stats else (None, None, 0)
            ...
            for chat_id, chat_name, message_count in chat_stats:
                cluster_stats = self.db.execute(f"""
                    SELECT 
            ...
            return UserStats(
                ...
                largest_chat=largest_chat,
                largest_cluster=largest_cluster if largest_cluster else (None, None, 0),
    ...
    def get_random_large_cluster(self, phone: str, min_size: int = 10) -> Optional[pl.DataFrame]:
        ...
        try:
            ...
            large_clusters = self.db.execute(f"""
            ...
            cluster_messages = self.db.execute(f"""
                SELECT 
                    m.*,
                    c.group_id
    ...
    def init_user_tables(self, phone: str):
        """
    ...
    def add_messages(self, phone: str, messages_df: pl.DataFrame):
        """
    ...
    def print_user_summary(self, phone: str):
        """
