    ...
    if file_name.startswith('messages') and file_name.endswith('.html'):
        ...
        with open(file_path, 'r', encoding='utf-8') as file:
            ...
            for message in messages:
                date_time = message.find('div', class_='pull_right date details')['title'] if message.find('div', class_='pull_right date details') else "Unknown"
                author = message.find('div', class_='from_name').text.strip() if message.find('div', class_='from_name') else "Unknown"
