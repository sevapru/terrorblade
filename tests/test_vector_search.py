...
class TestVectorSearch:
    ...
    @pytest.fixture
    def vector_store_with_data(self, test_db_path: str, telegram_database: TelegramDatabase, sample_messages_df: pl.DataFrame) -> VectorStore:
    ...
    def test_get_similar_messages_with_text(self, vector_store_with_data: VectorStore) -> None:
        ...
        expected_columns = {
            "message_id", "chat_id", "text", "chat_name", "from_name", 
            "date", "similarity", "cluster_id", "text_preview"
        }
